...
package net.moreblocks.sml.keybind;

import org.lwjgl.input.Keyboard;

import net.moreblocks.sml.procedure.ProcedureMbopCommandExecuted;
...
public class KeyBindingMeop extends ElementsMoreblocksMod.ModElement {
	private KeyBinding keys;
	public KeyBindingMeop(ElementsMoreblocksMod instance) {
		super(instance, 325);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.meop", Keyboard.KEY_F10, "key.categories.misc");
	...
	public void onKeyInput(InputEvent.KeyInputEvent event) {
		if (Minecraft.getMinecraft().currentScreen == null) {
			if (org.lwjgl.input.Keyboard.isKeyDown(keys.getKeyCode())) {
				MoreblocksMod.PACKET_HANDLER.sendToServer(new KeyBindingPressedMessage());
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureMbopCommandExecuted.executeProcedure($_dependencies);
		}
	}
}
