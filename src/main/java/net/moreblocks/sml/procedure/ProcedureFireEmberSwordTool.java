...
public class ProcedureFireEmberSwordTool extends ElementsMoreblocksMod.ModElement {
	public ProcedureFireEmberSwordTool(ElementsMoreblocksMod instance) {
		super(instance, 198);
	}
		...
		if ((((entity instanceof EntityPlayerMP) && ((entity).world instanceof WorldServer))
				? ((EntityPlayerMP) entity).getAdvancements()
						.getProgress(((WorldServer) (entity).world).getAdvancementManager()
								.getAdvancement(new ResourceLocation("moreblocks:firemeberswordsadv")))
						.isDone()
				: false)) {
			if ((Math.random() < 0.4)) {
