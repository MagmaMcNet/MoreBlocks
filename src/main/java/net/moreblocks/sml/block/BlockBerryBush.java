...
import net.moreblocks.sml.procedure.ProcedureBerryBushUpdateTick;
...
public class BlockBerryBush extends ElementsMoreblocksMod.ModElement {
	@GameRegistry.ObjectHolder("moreblocks:berry_bush")
	public static final Block block = null;
	public BlockBerryBush(ElementsMoreblocksMod instance) {
		super(instance, 218);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("moreblocks:berry_bush", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureBerryBushUpdateTick.executeProcedure($_dependencies);
			}
		}
