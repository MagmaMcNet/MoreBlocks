...
public class BlockObsidianOre extends ElementsMoreblocksMod.ModElement {
	@GameRegistry.ObjectHolder("moreblocks:obsidian_ore")
	public static final Block block = null;
	public BlockObsidianOre(ElementsMoreblocksMod instance) {
		super(instance, 4);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("moreblocks:obsidian_ore", "inventory"));
	}
