...
package net.moreblocks.sml.world.structure;
...
public class StructureDragonsho extends ElementsMoreblocksMod.ModElement {
	public StructureDragonsho(ElementsMoreblocksMod instance) {
		super(instance, 206);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 20000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("moreblocks", "dragon_sho"));
				if (template == null)
					return;
