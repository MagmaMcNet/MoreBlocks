...
public static class ModelFox_Idle extends ModelBase {
	...
	public ModelFox_Idle() {
		...
		head.setRotationPoint(1.0F, -6.5F, -7.0F);
		FOX.addChild(head);
		...
		body.setRotationPoint(0.0F, -9.5F, -4.5F);
		FOX.addChild(body);
		...
		leg1.setRotationPoint(5.0F, 6.5F, -2.0F);
		FOX.addChild(leg1);
		setRotationAngle(leg1, -1.5708F, 0.0F, 0.0F);
		leg1.cubeList.add(new ModelBox(leg1, 16, 16, -8.001F, 0.5F, -1.0F, 2, 6, 2, 0.0F, false));

		leg2 = new ModelRenderer(this);
		leg2.setRotationPoint(1.0F, 6.5F, -2.0F);
		FOX.addChild(leg2);
		setRotationAngle(leg2, -1.5708F, 0.0F, 0.0F);
		leg2.cubeList.add(new ModelBox(leg2, 16, 24, 0.001F, 0.5F, -1.0F, 2, 6, 2, 0.0F, false));

		leg3 = new ModelRenderer(this);
		leg3.setRotationPoint(-2.001F, 1.0F, -8.0F);
		FOX.addChild(leg3);
		setRotationAngle(leg3, -0.3491F, 0.0F, 0.0F);
		leg3.cubeList.add(new ModelBox(leg3, 8, 24, -1.0F, 0.0F, -1.0F, 2, 6, 2, 0.0F, false));

		leg4 = new ModelRenderer(this);
		leg4.setRotationPoint(2.001F, 1.0F, -8.0F);
		FOX.addChild(leg4);
		setRotationAngle(leg4, -0.3491F, 0.0F, 0.0F);
		leg4.cubeList.add(new ModelBox(leg4, 0, 24, -1.0F, 0.0F, -1.0F, 2, 6, 2, 0.0F, false));

		tail = new ModelRenderer(this);
		tail.setRotationPoint(0.0F, 4.0F, 0.0F);
		FOX.addChild(tail);

		tail_rotation = new ModelRenderer(this);
		tail_rotation.setRotationPoint(0.0F, -2.5F, 0.5F);
