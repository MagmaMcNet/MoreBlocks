...
public static class ModelFox_9_sitting extends ModelBase {
	...
	public ModelFox_9_sitting() {
		textureWidth = 48;
		textureHeight = 32;

		fox = new ModelRenderer(this);
		fox.setRotationPoint(1.0F, 12.5F, -2.0F);
		...
		body.setRotationPoint(-1.0F, -5.0F, 2.5F);
		fox.addChild(body);

		body_rotation = new ModelRenderer(this);
		body_rotation.setRotationPoint(0.0F, 10.0F, -0.5F);
		body.addChild(body_rotation);
		setRotationAngle(body_rotation, 0.3491F, 0.0F, 0.0F);
		...
		tail_rotation.setRotationPoint(0.0F, 6.8864F, 4.1704F);
		body_rotation.addChild(tail_rotation);
		setRotationAngle(tail_rotation, 0.9599F, 0.0F, 0.0F);
