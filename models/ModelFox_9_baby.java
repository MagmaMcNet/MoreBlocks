...
public static class ModelFox_9_baby extends ModelBase {
	...
	public ModelFox_9_baby() {
		...
		head.setRotationPoint(0.0F, -3.75F, 1.0F);
		Fox.addChild(head);
		...
		body_rotation.setRotationPoint(0.0F, 4.5F, -0.25F);
		...
		leg1.setRotationPoint(-1.0F, -3.25F, 5.0F);
		Fox.addChild(leg1);
		leg1.cubeList.add(new ModelBox(leg1, 4, 12, -0.5005F, -0.75F, -0.5F, 1, 3, 1, 0.0F, false));

		leg2 = new ModelRenderer(this);
		leg2.setRotationPoint(1.0F, -3.25F, 5.0F);
		Fox.addChild(leg2);
		leg2.cubeList.add(new ModelBox(leg2, 8, 8, -0.4995F, -0.75F, -0.5F, 1, 3, 1, 0.0F, false));
		...
		tail.setRotationPoint(2.5F, -5.5F, 6.5F);
		Fox.addChild(tail);
